<?php
Class ExtComboSH extends CoreComponent {
    const WAIT_VALUE_TIME = 3000;
    ...
    public function openByName($name){
        $xpathOpenByName = "//input[contains(@name, '%s')]/ancestor::div[1]/img[contains(concat(' ',@class, ' '),' x-form-arrow-trigger ')]";
