Ext4.define('VetmanagerApp.modules.administration.controller.settings.CassaSettings', {
    extend: 'Ext4.app.Controller'
    , views: [
        'VetmanagerApp.modules.administration.view.settings.CassaSettings'
    ]
    , requires: [
    ...
    , init: function() {
        ...
        if (!this.isEventExists('click', 'cassasettings button[action="save"]')) {
            obj['cassasettings button[action="save"]'] = {click: this.onSave};
        }

        if (!this.isEventExists('afterrender', 'cassasettings form')) {
            obj['cassasettings form'] = { afterrender: this.onAfterRender};
        }
