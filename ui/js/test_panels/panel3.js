    ...
    items: [
        {
            ...
            html: [
                ...
                'Создать 3 радиобатона и 4 чекбокса. Все это как-то выделить, бордером. Внизу сделать кнопку',
                'При нажатии на кнопку, снижу от нее отображать текстом какие радио и чекбоксы сейчас нажаты,',
